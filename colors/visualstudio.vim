...
if version >= 700
  ...
  hi PmenuSel       guifg=black     guibg=#ffbc29 gui=bold
  hi ColorColumn    guifg=NONE      guibg=#e0e0e0
endif
...
hi IncSearch    guibg=#8090a0     guifg=white gui=underline
...
hi Error        guifg=red       guibg=#FFDDDD   gui=bold,underline
hi Todo         guifg=blue      guibg=#e6db74    gui=bold,underline
hi Search       guifg=white     guibg=#33adff    gui=underline
