...
call TPluginRegisterRepo('vim-coffee-script')
...
call TPluginFiletype('snippets', ['ultisnips'])
...
call TPluginFiletype('xml', ['xmledit'])
...
call TPluginFiletype('vim', ['AutoAlign', 'vundle'])
...
call TPluginFiletype('c', ['AutoAlign', 'c.vim', 'vundle'])
call TPluginFiletype('nerdtree', ['nerdtree'])
call TPluginFiletype('php', ['xmledit'])
call TPluginFiletype('scheme', ['slimv.vim'])
call TPluginFiletype('python_pydoc', ['pydoc.vim'])
call TPluginFiletype('xhtml', ['xmledit'])
call TPluginFiletype('cs', ['Omnisharp', 'vim-csharp'])
call TPluginFiletype('git-log', ['git-vim'])
call TPluginFiletype('html', ['AutoAlign', 'indenthtml.vim', 'html5.vim', 'xmledit', 'vundle'])
call TPluginFiletype('cpp', ['AutoAlign', 'vundle'])
...
call TPluginFiletype('tex', ['AutoAlign', 'vundle'])
call TPluginFiletype('less', ['vim-less'])
call TPluginFiletype('make', ['c.vim'])
call TPluginFiletype('perl', ['vim-perl'])
call TPluginFiletype('python', ['rope-omni', 'pytest.vim', 'jedi-vim', 'pyflakes-pathogen', 'rope-vim'])
...
call TPluginFiletype('coffee', ['vim-coffee-script'])
...
call TPluginAutoload('airline#extensions#tmuxline', ['vim-airline', '.'])
...
call TPluginAutoload('coffee', ['vim-coffee-script', '.'])
...
call TPluginAutoload('visualrepeat#reapply', ['visualrepeat', '.'])
call TPluginAutoload('visualrepeat', ['visualrepeat', '.'])
...
call TPluginRegisterPlugin('Align', 'AlignMapsPlugin')
call TPluginCommand('com! AlignMapsClean', 'Align', 'AlignMapsPlugin')
...
call TPluginMap('map <silent> <script> <Plug>AM_T?', 'Align', 'AlignMapsPlugin')
call TPluginMap('map <silent> <script> <Plug>AM_T@', 'Align', 'AlignMapsPlugin')
call TPluginMap('map <silent> <script> <Plug>AM_TW@', 'Align', 'AlignMapsPlugin')
...
call TPluginRegisterPlugin('Align', 'AlignPlugin')
...
call TPluginRegisterPlugin('Align', 'cecutil')
...
call TPluginCommand('com! -bar -nargs=? RWP', 'Align', 'cecutil')
...
call TPluginCommand('com! -bar -nargs=1 WLR', 'Align', 'cecutil')
...
call TPluginRegisterRepo('cecutil')
call TPluginRegisterPlugin('cecutil', 'cecutil')
...
call TPluginRegisterRepo('QuickBuf')
call TPluginRegisterPlugin('QuickBuf', 'qbuf')
call TPluginFunction('SBRun', 'QuickBuf', 'qbuf')
...
call TPluginRegisterRepo('Source-Control')
call TPluginRegisterPlugin('Source-Control', 'srcctl')
call TPluginFunction('SSDlet', 'Source-Control', 'srcctl')
call TPluginFunction('SourceControl_CreateInfoLine', 'Source-Control', 'srcctl')
call TPluginFunction('SCGetLockStatus', 'Source-Control', 'srcctl')
call TPluginFunction('SCLockStat', 'Source-Control', 'srcctl')
call TPluginFunction('SrcCtl_addMenuSep', 'Source-Control', 'srcctl')
call TPluginFunction('SrcCtl_addMenuMapping', 'Source-Control', 'srcctl')
call TPluginCommand('command! -complete=file -bang -nargs=+ -count=0 SS', 'Source-Control', 'srcctl')
call TPluginCommand('command! -complete=dir -bang -nargs=* -count=0 SDeploy', 'Source-Control', 'srcctl')
call TPluginCommand('command! -complete=dir -bang -nargs=* -count=0 SPLocked', 'Source-Control', 'srcctl')
call TPluginCommand('command! -complete=file -bang -nargs=1 -count=0 VDiff', 'Source-Control', 'srcctl')
call TPluginFunction('SrcCtl_RegisterModule', 'Source-Control', 'srcctl')
...
call TPluginRegisterRepo('TaskList.vim')
call TPluginRegisterPlugin('TaskList.vim', 'tasklist')
call TPluginCommand('command! TaskList', 'TaskList.vim', 'tasklist')
call TPluginMap('nnoremap <unique> <script> <Plug>TaskList', 'TaskList.vim', 'tasklist')
...
call TPluginRegisterPlugin('vim-abolish', 'abbrev')
...
call TPluginMap('inoremap <silent> <Plug>ISurround', 'vim-surround', 'surround')
call TPluginRegisterRepo('vim-swap-lines')
call TPluginRegisterPlugin('vim-swap-lines', 'swap-lines')
...
call TPluginRegisterRepo('visualrepeat')
call TPluginRegisterPlugin('visualrepeat', 'visualrepeat')
